...
$eliminacion="delete from actividad_usuario where ID='$id' and DNI='$dni'";
$resultad=mysqli_query($bd,$eliminacion); 
if($resultad){
    echo "<h2>Se ha eliminado la inscripción correctamente</h2>";
}
else{
echo "<h2>No se ha podido eliminar la inscripción intentelo despues</h2>";
