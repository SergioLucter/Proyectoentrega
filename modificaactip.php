...
$ins=mysqli_query($bd,"UPDATE actividad SET `NOMBRE`='$nombre',`TIPO_ACTIVIDAD`='$tipo',`LUGAR`='$lugar',`FECHA_IN`='$fechain',`FECHA_FIN`='$fechafin',`ALOJAMIENTO`='$alojamiento',`PRECIO`='$precio',`COMIDAS`='$comidas' WHERE ID='$id'");
if($ins){
    echo "<h2>Se ha modificado la actividad con exito</h2>";
}
else{
    print_r($_POST);
echo "<h2>No se ha conseguido modificar con exito</h2>";}
?>
</body></hmtl>