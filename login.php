...
$ins=mysqli_query($bd,"SELECT * FROM usuario where correo like '$correo' and password like '$contraseña'");
if(mysqli_num_rows($ins)>0){
$_SESSION["usuario"]["correo"]=$correo;
 echo "<h2 class='correcto'>el login ha sido correcto</h2>";
echo "<a href='inicio.php'><p>ir al inicio<p></a>";
}
else{
 echo "<h2 class='error'>No se ha podido loguear lamentablemente</h2>";
echo "<a href='login.html'><p>volver al formulario<p></a>";
}
?>
</body></htm>