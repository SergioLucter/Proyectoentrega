...
$sql= "SELECT DNI from usuario where CORREO='$correo'";
...
extract($valor1);
$sql2= "INSERT INTO `actividad_usuario`(`DNI`, `ID`, `preciototal`, `personas`) VALUES ('$DNI','$indice1',$precio,$personas)";
$ins2=mysqli_query($bd,$sql2);
if($ins2){
    echo "<h2>Se ha completado la compra puede volver al incio</h2>";
}
}
