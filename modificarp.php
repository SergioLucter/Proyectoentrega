...
$ins=mysqli_query($bd,"UPDATE `usuario` SET `NOMBRE_APELLIDOS`='$nombre',`CORREO`='$correo',`TELEFONO`=$telefono,`password`='$contraseña' WHERE DNI ='$dni' and correo != 'admin@gmail.com'");
if($ins){
echo "<h2>Se ha podido modificar los datos con exito</h2>";
}
else{
echo "<h2>No se han podido modificar los datos</h2>";}
?>
</body></hmtl>