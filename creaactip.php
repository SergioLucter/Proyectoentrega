...
$ins=mysqli_query($bd,"INSERT INTO `actividad`( `NOMBRE`, `TIPO_ACTIVIDAD`, `LUGAR`, `FECHA_IN`, `FECHA_FIN`, `ALOJAMIENTO`, `PRECIO`, `COMIDAS`) VALUES ('$nombre','$tipo','$lugar','$fechain','$fechafin','$alojamiento','$precio','$comidas')");
if($ins){
echo "<h2>Se ha creado la actividad correctamente</h2>";
}
else{
echo "<h2>No se ha podido crear la actividad</h2>";}
?>
</body></hmtl>