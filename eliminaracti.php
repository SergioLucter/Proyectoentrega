...
$res=mysqli_query($bd,"delete  from actividad_usuario where ID=$id");
if($res){
$ins=mysqli_query($bd,"delete  from actividad where ID=$id");
if($ins){
echo "<h2>Se ha eliminado la actividad con exito</h2>";
}
else{
echo "<h2>No se ha conseguido eliminar con exito</h2>";}
}
?>
</body></hmtl>