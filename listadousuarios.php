...
<tr><td>Dni</td> <td>nombre</td> <td>correo</td><td>telefono</td></tr>
<?php 
$bd=mysqli_connect("localhost","id20911504_admin","#Alfanmc02","id20911504_turismo");
$ins=mysqli_query($bd,"SELECT * FROM usuario where CORREO != 'admin@gmail.com'");
while($fila=mysqli_fetch_assoc($ins)){
extract($fila);
echo "<tr><td>$DNI</td><td>$NOMBRE_APELLIDOS</td><td>$CORREO</td><td>$TELEFONO</td><td><a href='modificar.php?dni=$DNI&nombre=$NOMBRE_APELLIDOS&correo=$CORREO&telefono=$TELEFONO&password=$password'><button type='button' class='btn btn-primary'>modificar</button></a></td><td><a href='eliminar.php?dni=$DNI'><button type='button' class='btn btn-primary'>dar de alta</button></a></td></tr>";
}
?>
</table>
</div>
