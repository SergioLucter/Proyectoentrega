...
extract($fila);
echo "
<h1> Creación de nuevo tipo de actividad </h1>
<div class='container formulario'>
<form action='nuevotipop.php' method='POST'>
   <div class='mb-3'>
    <label for='nombre' class='form-label'>nombre del tipo</label>
    <input type='text' class='form-control' id='nombretip' placeholder='escriba aqui el tipo' name='nombre'>
  </div>
